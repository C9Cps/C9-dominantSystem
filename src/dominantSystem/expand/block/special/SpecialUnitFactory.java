...
public class SpecialUnitFactory extends UnitBlock {
    public int[] capacities = {};

    public Seq<UnitPlan> plans = new Seq<>(4);

    public SpecialUnitFactory(String name){
        super(name);
        update = true;
        hasPower = true;
        hasItems = true;
    ...
    public class UnitFactoryBuild extends UnitBuild{
        ...
        public void buildConfiguration(Table table){
            ...
            if(units.any()){
                ItemSelection.buildTable(SpecialUnitFactory.this, table, units, () -> currentPlan == -1 ? null : plans.get(currentPlan).unit, unit -> configure(plans.indexOf(u -> u.unit == unit)), selectionRows, selectionColumns);
