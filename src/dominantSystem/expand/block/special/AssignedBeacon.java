...
public class AssignedBeacon extends AdaptOverdriveProjector {
    ...
    public void setBars() {
        ...
        addBar("productivity", (AssignedBeaconBuild e) -> new Bar(
                () -> Core.bundle.format("ds.bar.productivity-boost", Strings.autoFixed((e.realBoost()) * 100, 0)),
                () -> Pal.ammo,
                () -> 1f
        ));
    }
    ...
    public void setStats() {
        super.setStats();
        stats.add(dsStats.maxLinks, maxLink, StatUnit.none);
    }
    ...
    public class AssignedBeaconBuild extends AdaptOverdriveProjectorBuild{
        ...
        public void updateLink(){
            linkBuilds().each(b -> {
                ...
                if (b.block instanceof GenericCrafter crafter && b instanceof GenericCrafter.GenericCrafterBuild build){
                    ...
                    if (progress >= 1f){
                        if (b.block instanceof RecipeCrafter crafter1 && b instanceof RecipeCrafter.RecipeCrafterBuild build1){
        ...
        public boolean containBuild(Building b) {
            ...
            dsGroups.beaconBoostLinks.each((source, targets) -> {
        ...
        public void drawConfigure() {
            ...
            dsGroups.beaconBoostLinks.keys().toSeq().each(b -> {
        ...
        public void checkLinks() {
            ...
            dsGroups.beaconBoostLinks.put(this, linkBuilds());
        }

        @Override
        public void remove() {
            super.remove();
            dsGroups.beaconBoostLinks.remove(this);
        }
