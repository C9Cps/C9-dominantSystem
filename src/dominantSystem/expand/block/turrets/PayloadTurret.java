package dominantSystem.expand.block.turrets;
...
import arc.util.*;
import arc.util.io.*;
import dominantSystem.content.dsBullets;
import dominantSystem.content.dsContent;
...
public class PayloadTurret extends Turret{
    ...
    public BulletType shootType = dsBullets.payBullet;
    public BulletType homingShootType = dsBullets.homingPay;
    ...
    public void init(){
        super.init();
        homingBlocks.addAll(dsContent.thiriumWall, dsContent.adaptiveDrill);
    }
    ...
    public class PayloadTurretBuild<T extends Payload> extends TurretBuild{
        ...
        public void drawPayload(){
            if(payload != null){
                ...
                if(loaded){
                    ...
                    payRotation = rotation -45 + rotationOffset();
                }
        ...
        public boolean acceptPayload(Building source, Payload pay){
            return payload == null && pay.fits(maxPaySize) && super.acceptPayload(source, payload) && payload.content() instanceof ModulePayload;
        }
        ...
        public void handlePayload(Building source, Payload pay){
            ...
            if(payload instanceof BuildPayload bp && !bp.block().rotate) this.payRotation = -45f;
