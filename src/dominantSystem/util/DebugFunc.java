...
import dominantSystem.util.graphic.DrawFunc;

import java.util.Objects;

import static mindustry.Vars.*;
import static dominantSystem.dominantSystemMod.MOD;

public class DebugFunc {
    public static final String ds_ROOT_PATH = "E:/project/MindustryModDevLib/NewHorizonMod";
    public static final String ds_BUNDLE_PATH = ds_ROOT_PATH + "/assets/bundles/blank/";
    public static final String ds_SPRITE_PATH = ds_ROOT_PATH + "/assets/sprites";
    public static final String ds_DEBUG_GRAPHIC_FOLDER = ds_SPRITE_PATH + "/debug/";
    public static final String ds_DEBUG_JSON_DATA_FOLDER = ds_ROOT_PATH + "/data/";
    public static final String ds_SPRITE_ICON_PATH = ds_ROOT_PATH + "/icons/";
    public static final Color[] ds_SPRITE_PALETTE = {
    ...
    public static void generateBlankBundle() {
        ...
        Fi blankBundle = new Fi(ds_BUNDLE_PATH + "bundle.blank-content.txt");
    ...
    public static Fi createPNGFile(String fileName) {
        return new Fi(ds_DEBUG_GRAPHIC_FOLDER + fileName + ".png");
    }

    public static Fi createIconPNGFile(String fileName) {
        return new Fi(ds_SPRITE_ICON_PATH + fileName + ".png");
    }

    public static Fi createJsonFile(String fileName) {
        return new Fi(ds_DEBUG_JSON_DATA_FOLDER + fileName + ".json");
    }
    ...
    public static void outlineIcon() {
        Fi folder = new Fi(ds_DEBUG_GRAPHIC_FOLDER);
    ...
    public static void outlineSprite(Fi sprite, Color color, int stroke, boolean expand, boolean smooth) {
        ...
        Fi fi = new Fi(ds_DEBUG_GRAPHIC_FOLDER + "/outline/" + sprite.nameWithoutExtension() + "-outline.png");
    ...
    public static void replaceSpriteColor(String parentPath, Fi sprite, Color[] palette) {
        ...
        Fi out = new Fi(ds_DEBUG_GRAPHIC_FOLDER + parent.name().replace(parentPath, "") + "/" + sprite.name());
        Pixmap pixmap = new Pixmap(sprite);
        pixmap.each((x, y) -> {
            if (pixmap.get(x, y) == palette[0].rgba()) pixmap.set(x, y, ds_SPRITE_PALETTE[0]);
            if (pixmap.get(x, y) == palette[1].rgba()) pixmap.set(x, y, ds_SPRITE_PALETTE[1]);
            if (pixmap.get(x, y) == palette[2].rgba()) pixmap.set(x, y, ds_SPRITE_PALETTE[2]);
            if (pixmap.get(x, y) == palette[3].rgba()) pixmap.set(x, y, ds_SPRITE_PALETTE[3]);
        });
    ...
    public static void updateBlockList() {
        ...
        Fi.get(ds_ROOT_PATH).child("blocklist.txt").writeString(sb.toString());
    }

    public static String readBlockList() {
        Fi fi = Fi.get(ds_ROOT_PATH).child("blocklist.txt");
