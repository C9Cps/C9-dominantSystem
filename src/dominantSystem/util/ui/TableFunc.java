package dominantSystem.util.ui;
...
import dominantSystem.expand.entities.UltFire;
import dominantSystem.util.PixelArtGenerator;
import dominantSystem.util.ui.dialog.DebugDialog;
...
public class TableFunc {
    ...
    public static void tableMain() {
        ...
        starter.visible(() -> !state.isMenu() && ui.hudfrag.shown && (!net.client() || dominantSystemMod.DEBUGGING) && starter.color.a > 0.01f);
