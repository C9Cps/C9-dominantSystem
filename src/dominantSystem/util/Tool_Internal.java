...
public class Tool_Internal {
    ...
    public static void patchBundle() {
        new BaseDialog("") {{
            cont.fill(t -> {
                Mods.LoadedMod mod = Vars.mods.getMod(dominantSystemMod.class);
    ...
    public static void fireAnime() {
        ...
        Vars.ui.loadAnd("[accent]Generating", () -> {
            Color from = dsPal.thiriumAmmoFront, to = Color.darkGray;

            Fi root = dsPixmap.processedDir();
            ...
            int num = 13;
            int total = 40;
            String name = ("square"), outPut = "ult-fire-";
            int size = 160;
            float step = 1.9f;
            ...
            for (int fIndex = 0; fIndex < total; fIndex++) {
                ...
                for (int i = 0; i < num; i++) {
                    ...
                    dsPixmap.mulColor(pixmap, Tmp.c1);
